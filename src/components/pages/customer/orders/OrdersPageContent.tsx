		...
		>
			...
			<div className="px-6 py-5 bg-muted/60 border-b flex flex-col md:flex-row md:items-center justify-between gap-4">
				...
				<div className="flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-8">
					...
					<div>
						<p className="text-xs text-muted-foreground">Total</p>
						<p className="font-bold text-2xl text-primary">৳{Number(order.total_price).toLocaleString()}</p>
					</div>
						...
						<div key={idx} className="flex gap-5 group">
							...
							<div className="flex-1 min-w-0 pt-1">
								...
								<div className="mt-3 flex items-center justify-between">
									...
									<div className="text-right">
										<p className="font-semibold text-lg">৳{(Number(unitPrice) * qty).toLocaleString()}</p>
										<p className="text-xs text-muted-foreground">@ ৳{Number(unitPrice).toLocaleString()} each</p>
									</div>
								</div>
							</div>
						</div>
