...
function Pagination({ className, ...props }: React.ComponentProps<'nav'>) {
	return <nav role="navigation" aria-label="pagination" data-slot="pagination" className={cn('py-2 px-2', className)} {...props} />;
}
	...
	return (
		<a
			...
			className={cn(
				...
				isActive && 'bg-dashboard-primary text-white hover:text-white hover:bg-dashboard-primary/80',
				className,
			)}
			{...props}
		/>
